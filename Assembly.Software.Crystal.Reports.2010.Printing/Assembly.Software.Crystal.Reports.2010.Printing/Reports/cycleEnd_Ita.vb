...
Public Class cycleEnd_Ita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintCrystalReportFile.cycleEnd_Ita.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_vchInventoryPackNO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcycleEnd_Ita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cycleEnd_Ita = New cycleEnd_Ita()
        rpt.Site = Me.Site
        Return rpt
    End Function
