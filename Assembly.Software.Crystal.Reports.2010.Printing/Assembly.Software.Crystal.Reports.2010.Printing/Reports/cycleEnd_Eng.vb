...
Public Class cycleEnd_Eng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintCrystalReportFile.cycleEnd_Eng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcycleEnd_Eng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cycleEnd_Eng = New cycleEnd_Eng()
        rpt.Site = Me.Site
        Return rpt
    End Function
