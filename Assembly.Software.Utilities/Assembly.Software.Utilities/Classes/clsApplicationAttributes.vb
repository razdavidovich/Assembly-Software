...
Public Class clsApplicationAttributes
    ...
    Public Sub New()
        ...
        Dim objCLSCompliant As CLSCompliantAttribute = CType(CLSCompliantAttribute.GetCustomAttribute(System.Reflection.Assembly.GetExecutingAssembly, GetType(CLSCompliantAttribute)), CLSCompliantAttribute)
        ...
        strVersion = verApplication.ToString
        strDescription = objDescription.Description
        strCopyright = objCopyright.Copyright
        strTrademark = objTrademark.Trademark
        strExecutablePath = System.AppDomain.CurrentDomain.BaseDirectory()
        strStartupPath = System.Reflection.Assembly.GetExecutingAssembly().Location
        strGUID = objGuid.Value
        blnCLSCompliant = True 'objCLSCompliant.IsCompliant
