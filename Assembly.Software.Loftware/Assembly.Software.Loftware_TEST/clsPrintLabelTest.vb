...
'''<summary>
'''This is a test class for clsPrintLabelTest and is intended
'''to contain all clsPrintLabelTest Unit Tests
'''</summary>
<TestClass()> _
Public Class clsPrintLabelTest
...
#End Region
    ...
    Public Sub PrintLabelFromDataTable_Test()
        ...
        Dim target As clsPrintLabel = New clsPrintLabel
        ...
        'Execute the tests
        lstReturnedStatus = target.PrintLabel(strLoftwareServerIPAddress, strLoftwareServerPort, strPrinterID, strLabelName, intSerializedLabels, intNumberOfCopies, _
