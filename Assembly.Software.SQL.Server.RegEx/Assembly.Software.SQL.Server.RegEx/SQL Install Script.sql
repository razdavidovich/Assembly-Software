...
CREATE ASSEMBLY RegExFunction
           FROM 'D:\Team Projects\Complied Assemblies\Assembly.Software.SQL.Server.RegEx.dll'
GO
...
returns int
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExOptionEnumeration
...
RETURNS BIT
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExIsMatch
GO
...
RETURNS int
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExIndex
GO
...
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExMatch
GO
...
RETURNS NVARCHAR(MAX)
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExEscape
GO
...
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExSplit
GO
...
RETURNS  NVARCHAR(MAX)
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExReplace
GO
...
RETURNS  NVARCHAR(MAX)
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExReplacex
GO
...
AS EXTERNAL NAME 
   RegexFunction.[Assembly.Software.SQL.Server.RegEx.RegularExpressionFunctions].RegExMatches
GO
