...
Public Class RegularExpressionFunctions
    ...
    Public Shared Function RegExMatch(ByVal pattern As SqlString, _
        ...
        RegexOption = Options
        Return Text.RegularExpressions.Regex.Match(input.Value, pattern.Value, RegexOption).Value
    End Function
    ...
    Public Shared Function RegExIsMatch( _
        ...
        Dim RegexOption As New System.Text.RegularExpressions.RegexOptions
        RegexOption = Options
        Return Text.RegularExpressions.Regex.IsMatch(input.Value, pattern.Value, RegexOption)
    End Function         '
    '          RegExIndex function
    ...
    Public Shared Function RegExIndex(ByVal pattern As SqlString, _
        ...
        Dim RegexOption As New System.Text.RegularExpressions.RegexOptions
        RegexOption = Options
        Return Text.RegularExpressions.Regex.Match(input.Value, pattern.Value, RegexOption).Index
    End Function
    '----------end of RegExMatch function
    ...
    Public Shared Function RegExEscape(ByVal input As SqlString) As SqlString
        If (input.IsNull) Then
            Return String.Empty
        End If
        Return Text.RegularExpressions.Regex.Escape(input.Value)
    End Function
    ...
    Public Shared Function RegExSplit( _
        ...
        Dim RegexOption As New System.Text.RegularExpressions.RegexOptions
        RegexOption = Options
        Return Text.RegularExpressions.Regex.Split(input.Value, pattern.Value, RegexOption)
    End Function
    ...
    Public Shared Function RegExReplace(ByVal input As SqlString, _
        ...
        End If
        Return New SqlString(Text.RegularExpressions.Regex.Replace(input.Value, pattern.Value, _
    ...
    Public Shared Function RegExMatches(ByVal pattern As SqlString, _
        ...
        Dim RegexOption As New System.Text.RegularExpressions.RegexOptions
        RegexOption = Options
        Return Text.RegularExpressions.Regex.Matches(input.Value, pattern.Value, RegexOption)
    End Function
