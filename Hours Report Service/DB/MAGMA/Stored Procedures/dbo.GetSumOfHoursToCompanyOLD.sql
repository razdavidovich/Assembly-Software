...
-- =============================================
CREATE PROCEDURE [dbo].[GetSumOfHoursToCompanyOLD] 
...
SELECT     dbo.HoursToEmployee_Ta.TaskCode, dbo.Company_Ta.CompanyName, SUM(dbo.HoursToEmployee_Ta.HoursToEmployee) AS TotalHours, 
                      dbo.ALL_Tasks_Ve.ShortDescription
...
GROUP BY dbo.HoursToEmployee_Ta.TaskCode, dbo.ALL_Tasks_Ve.ShortDescription, dbo.Company_Ta.CompanyName
END
